...
# If there are any discrepancies between the two APIs (e.g. there is another option available but Intune doesn't support it),
# we will throw an error upon encountering the discrepancy.
