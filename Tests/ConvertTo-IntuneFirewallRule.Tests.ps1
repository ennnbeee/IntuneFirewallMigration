. "$PSScriptRoot\..\IntuneFirewallMigration\Public\ConvertTo-IntuneFirewallRule.ps1"
. "$PSScriptRoot\..\IntuneFirewallMigration\Private\ConvertTo-IntuneFirewallRule-Helper.ps1"
